...
namespace HDWallet.Algorand.Tests
{
    ...
    public class Tests
    {
        ...
        public void ShouldGeneratedFromMnemonic()
        {
            ...
            ClassicAssert.AreEqual(expected: "5RKLKOVRU4WRWEKKI5I5Z6HTRNYA3XD6HGU34ZDRCDLJJ3DYQEOAOEWODY", wallet.Address);
            ClassicAssert.AreEqual(expected: "ec54b53ab1a72d1b114a4751dcf8f38b700ddc7e39a9be647110d694ec78811c", wallet.PublicKeyBytes.ToHexString());
            ClassicAssert.AreEqual(expected: "12c1a9991a216b2c8c86110e3bb6813920562e21090126b7813c525906f32f5f", wallet.PrivateKeyBytes.ToHexString());
            ...
            ClassicAssert.AreEqual(expected: "9db2f34d61c94d5c5cf84e3cc8f63203319ca827dd7d26071f298f93c8465e4665c83effdccc2db72839a02d812b4ab1c38fbdd662d42e7d4a15ff307abb1303", sighex);
        }
        ...
        public void ShouldGeneratedFromXprv()
        {
            ...
            ClassicAssert.AreEqual("xprv9s21ZrQH143K3xUTDYV4BjfSvuVscczTMw7LtNWgjYBLLGHPqagsJm9YyQihApsr8UFEP9ydzVzTdVezhaDVFDciCGMLhV5Yp8s2fRT7qh9", account0.GetWif());
            ...
            ClassicAssert.AreEqual(wallet.PublicKeyBytes, actualWallet.PublicKeyBytes);
            ClassicAssert.AreEqual(expected: "5RKLKOVRU4WRWEKKI5I5Z6HTRNYA3XD6HGU34ZDRCDLJJ3DYQEOAOEWODY", actualWallet.Address);
