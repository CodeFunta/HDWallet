...
namespace HDWallet.Avalanche.Tests
{
    public class GenerateAccountHDWallet
    {
        ...
        public void ShouldCreateAccount()
        {
            ...
            ClassicAssert.AreEqual("6f5139852a78fdb4bd790a46fbb34a98cabb1a946a724917efa94a2a41d82d7d", account0wallet0.PrivateKey.ToHex());
            ...
            ClassicAssert.AreEqual("6f5139852a78fdb4bd790a46fbb34a98cabb1a946a724917efa94a2a41d82d7d", depositWallet0.PrivateKey.ToHex());
        ...
        public void ShouldCreateAddressFromMnemonic()
        {
            ...
            ClassicAssert.AreEqual("X-avax1wn9s0qlpeur87pk2ccxajlj68d5wt3tw3tts8z", account0wallet0.Address);
        }
        ...
        public void ShouldCreateAddressFromPrivateKey()
        {
            ...
            ClassicAssert.AreEqual("X-avax1wn9s0qlpeur87pk2ccxajlj68d5wt3tw3tts8z", wallet.Address);
        }
        ...
        public void ShouldCreateAddressFromMasterKey()
        {
            ...
            IAccount<AvalancheWallet> accountHDWallet = AvalancheHDWallet.GetAccountFromMasterKey(accountExtendedPrivateKey);
            var depositWallet0 = accountHDWallet.GetExternalWallet(0);
            ClassicAssert.AreEqual("X-avax1as0rhx4ejjfm3vzmhxycs58v4lu4u9h7amfqmx", depositWallet0.Address);
        }
    }
}