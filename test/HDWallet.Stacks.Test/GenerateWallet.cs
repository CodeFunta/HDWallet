...
namespace HDWallet.Stacks.Test
{
    public class GenerateWallet
    {
        ...
        public void ShouldGenerateWalletFromPrivateKey()
        {
            ...
            ClassicAssert.AreEqual("c216ddb515f247a7463be98569ba0c526d9da33ddf345e73ef78f0221c3427f3", wallet0.PrivateKey.ToHex());
            ClassicAssert.AreEqual("STMQVWWA1JA2HSGB4KX02VN185DA3W8B5V7WAXK",wallet0.GetAddress(NetworkVersion.Testnet) );

            var stacksWallet = new StacksWallet("c216ddb515f247a7463be98569ba0c526d9da33ddf345e73ef78f0221c3427f3");
            ClassicAssert.AreEqual(wallet0.PrivateKey.ToHex(), stacksWallet.PrivateKey.ToHex());
            ClassicAssert.AreEqual(wallet0.Address, stacksWallet.Address);
        }
    }
}