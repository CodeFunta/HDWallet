...
namespace HDWallet.FileCoin.Tests
{
    public class GenerateHDWallet
    {
        ...
        public void ShouldCreateAccount()
        {
            ...
            ClassicAssert.AreEqual("efdeb7af4fddd16982be22789ebf0842963df505e79fd4bb723d77179a1938ae", account0wallet0.PrivateKey.ToHex());
            ...
            ClassicAssert.AreEqual("efdeb7af4fddd16982be22789ebf0842963df505e79fd4bb723d77179a1938ae", depositWallet0.PrivateKey.ToHex());
            ClassicAssert.AreEqual(account0wallet0.PrivateKey, depositWallet0.PrivateKey);

            ClassicAssert.AreEqual("02495816397ce56afd5345ba60ae6eb52d3f27f586df536ebc2632b8698be5387c", depositWallet0.PublicKey.ToHex());
        ...
        public void ShouldCreateAddressFromMnemonic()
        {
            ...
            IHDWallet<FileCoinWallet> wallet = new FileCoinHDWallet(words);
            var account0wallet0 = wallet.GetAccount(0).GetExternalWallet(0); 
            ClassicAssert.AreEqual("f1d5m6e523gek3jsbn6kl7bsurd2vyuvs6wyvnmyy", account0wallet0.Address);
        }
        ...
        public void ShouldCreateAddressFromMasterKey()
        {
            ...
            IAccount<FileCoinWallet> accountHDWallet = FileCoinHDWallet.GetAccountFromMasterKey(accountExtendedPrivateKey);
            var depositWallet0 = accountHDWallet.GetExternalWallet(0);
            ClassicAssert.AreEqual("f1gdrlcunry4lagktmexhudtfxmndtlm7wijcu35a", depositWallet0.Address);
        }
    }
}