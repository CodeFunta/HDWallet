...
namespace HDWallet.Tron.Tests
{
    public class GeneratePrivateKey
    {
        ...
        public void ShouldGenerateMasterPrivateKeys()
        {
            ...
            ClassicAssert.AreEqual("043be47cf1c281f4843cb6cc991c91d9122dde87ac42ee8bc393ee0033988fc6f15372cb24f8885d5d29dba94a9f761c44a8bb0a5dd6f6856d925921a2c3386e6f", publicKeyHex);
            ClassicAssert.AreEqual("TNzDgpvjv48DGMGrendez5LsCn4nwjgLHx", account.Address);
        }
        ...
        public void ShouldGenerateFromSeed(string words, string address)
        {
            ...
            ClassicAssert.AreEqual(address, wallet0.Address);
        }
        ...
        public void ShouldGeneratePrivateKeys()
        {
            ...
            ClassicAssert.AreEqual("f017915411a0e7827e8f1f357c4ed2ccdcb1b1295cdb0fb0a5c13cbbd5da3734", privateKey);
            ClassicAssert.AreEqual("TEFccUNfgWyjuiiUo9LfNSb56jLhBo7pCV", address);
        }
        ...
        public void ShouldGeneratePrivateKeysFromAccounts()
        {
            ...
            ClassicAssert.AreEqual("f017915411a0e7827e8f1f357c4ed2ccdcb1b1295cdb0fb0a5c13cbbd5da3734", privateKey);
            ClassicAssert.AreEqual("TEFccUNfgWyjuiiUo9LfNSb56jLhBo7pCV", address00);
            ...
            ClassicAssert.AreEqual("TQYqPobCzY5sWpWF8wFYL9zmPsfzEESQ6Z", address10);
        }
    }
}