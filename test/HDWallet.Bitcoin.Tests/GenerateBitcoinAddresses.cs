...
namespace HDWallet.Bitcoin.Tests
{
    public class GenerateBitcoinAddresses
    {
        ...
        public void ShouldGenerateDepositAddress()
        {
            ...
            ClassicAssert.AreEqual(expected: "bc1qpznrn52ajq3uqf3ckmfsqdp2wspaggpl47ul3d", actual: depositAddress);
        ...
        public void ShouldGenerateFromPrivateKey()
        {
            ...
            ClassicAssert.AreEqual(expected: "0354b36b66431bbcf41607901d1a55e083cedbc3446b9849e06bcff81d0a3b517d", actual: pubKey.ToString());

            var walletAddress = bitcoinWallet.Address;
            ClassicAssert.AreEqual(expected: "bc1qpznrn52ajq3uqf3ckmfsqdp2wspaggpl47ul3d", actual: walletAddress);
        }
        ...
        public void ShouldGenerateChangeAddress()
        {
            ...
            var publicKey = walletDeposit.PublicKey;
            var depositAddress = walletDeposit.Address;
            ClassicAssert.AreEqual(expected: "bc1qdynrthkttgqkazjjgpd2qhh37868nvgytvgq50", actual: depositAddress);
        ...
        public void ShouldGenerateTestnetAddress()
        {
            ...
            ClassicAssert.AreEqual(expected: "tb1qdynrthkttgqkazjjgpd2qhh37868nvgyp2nn0u", actual: depositAddress);
