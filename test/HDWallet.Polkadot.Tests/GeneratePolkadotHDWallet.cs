...
namespace HDWallet.Polkadot.Tests
{
    public class GeneratePolkadotHDWallet
    {
        ...
        public void ShouldGenerateFromMnemonic()
        {
            ...
            ClassicAssert.AreEqual(expected: "8bd78fe8b30abf91d3e9474c8927d9874fabc7e31ce2d866cf795378161f954a", actual: privateKey.ToHexString());
            ClassicAssert.AreEqual(expected: "8bd78fe8b30abf91d3e9474c8927d9874fabc7e31ce2d866cf795378161f954ab29b533725c02f6e69d8774c92d8a5a98506c2f09e13a1adbe4db367fbfa512a", actual: expandedPrivateKey.ToHexString());
            ClassicAssert.AreEqual(expected: "b29b533725c02f6e69d8774c92d8a5a98506c2f09e13a1adbe4db367fbfa512a", actual: publicKey.ToHexString());
            ClassicAssert.AreEqual(expected: "5G6tXDeie2KaUgGrwkBfzApKSCm9sE5QvBm1bi1vmBZ4gcCN", actual: address);
            ClassicAssert.AreEqual(expected: "153BfYunVob3vDHNuPEg8KeUHpkoZXdYzgVVm11HKGaarp6Y", actual: polkadotAddress);
        ...
        public void ShouldGenerateKusamaFromMnemonic()
        {
            ...
            ClassicAssert.AreEqual(expected: "5EkVRZntoGaMkRS4o9hFF6EWPgLFoP4vFSicNHqL9TFF6Sow", actual: address);
            ClassicAssert.AreEqual(expected: "13gnZu3xf3qqBxSaknkFPF4fFJKuVgd4KwT6XapghYGmH365", actual: wallet.GetNetworkAddress(AddressType.PolkadotLive));
        }
        ...
        public void ShouldGenerateAddressForMultipleChain()
        {
            ...
            ClassicAssert.AreEqual(expected: "5G6tXDeie2KaUgGrwkBfzApKSCm9sE5QvBm1bi1vmBZ4gcCN", actual: genericNetworkAddress);
        ...
        public void ShouldGenerateMultipleFromSeed(int index, string expectedAddress)
        {
            ...
            ClassicAssert.AreEqual(expected: expectedAddress, actual: wallet.Address);
        }
    }
}