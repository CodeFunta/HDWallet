...
namespace HDWallet.Terra.Test
{
    public class GenerateWallet
    {
        ...
        public void ShouldGenerateWalletFromPrivateKey()
        {
            ...
            ClassicAssert.AreEqual("b1e18ce76ac82ea0e9d752a51964131e1e7aad1856d359bfa596ae94b87ea181", wallet0.PrivateKey.ToHex());

            var terraWallet = new TerraWallet(wallet0.PrivateKey.ToHex());
            ClassicAssert.AreEqual(wallet0.PrivateKey.ToHex(), terraWallet.PrivateKey.ToHex());
            ClassicAssert.AreEqual(wallet0.Address, terraWallet.Address);
        }
    }
}